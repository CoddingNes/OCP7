    ...
    return (
        <li
            ...
            <div className={hidden ? 'component dropdown__box' : 'component dropdown__box translate'} >
                ...
                <img
                    id="img" src={ArrowDown}
                    alt="Flèche déroulante"
                    className={hidden ? 'component dropdown__image hidden' : 'component dropdown__image'} />
                <img
                    src={ArrowUpown}
                    alt="Flèche déroulante"
                    className={hidden ? 'component dropdown__image' : 'component dropdown__image hidden'} />
            </div>
